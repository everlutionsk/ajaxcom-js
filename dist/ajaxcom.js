...
function ajaxcom(options) {
    var ajaxcomOptions = __assign({ beforeSend: function () { return Promise.resolve(); }, complete: function () { return undefined; }, error: onError, formsSelector: "form:not([data-ignore-ajaxcom])", linksSelector: "a:not([target=_blank]):not([data-ignore-ajaxcom])", success: function () { return Promise.resolve(); } }, options);
